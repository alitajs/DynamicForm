...
test("this is getInitKeyValue test", async () => {
  let form: FormInstance<string> = {
    ...
    getFieldError: (number) => { return [""] },
    getFieldsError: () => { return [] },
    isFieldsTouched: () => { return true },
    isFieldTouched: () => { return false },
    isFieldValidating: () => { return false },
    isFieldsValidating: () => { return false },
    resetFields: () => { },
    setFields: () => { },
    setFieldsValue: () => { },
    submit: () => { },
  ...
  console.log(
    getInitKeyValue({ form: form, key: "index", data: ["1", "2", { initKey: "index" }] })
  );
})
// utils
...
test("this is transformFile test", async () => {
  ...
  expect(transformFile("https://img2.baidu.com/it/u=2770537964,1423592535&fm=26&fmt=auto&gp=0.jpg")).toBeDefined()
  transformFile(lookPng).then((result: any) => {
